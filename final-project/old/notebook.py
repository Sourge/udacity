...
# 
# I will first try to classify the houses depending on their loction. These Locations will have an impact on the improved regression function which will be used in the next part.
# 
